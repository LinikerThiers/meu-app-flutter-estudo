...
class DadosCadastaisModelAdapter extends TypeAdapter<DadosCadastaisModel> {
  @override
  final int typeId = 0;

  @override
  DadosCadastaisModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return DadosCadastaisModel()
  ...
  @override
  void write(BinaryWriter writer, DadosCadastaisModel obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.nome)
  ...
  bool operator ==(Object other) =>
      ...
      other is DadosCadastaisModelAdapter &&
